...
export default function options(){
    ...
    options.appendChild(option("./assets/elements/depilação.png", "Depilação com cera", "Fazemos nossa própria cera, não alérgica, não agride. Profissionais especialistas."))
